...
public class configKafka {
    ...
    KafkaReceiver<String, String> kafkaReceiver() {
        ...
        ReceiverOptions<String, String> receiverOptions = ReceiverOptions.<String, String>create(configProps)
                .subscription(Collections.singleton(topicName));
        return new DefaultKafkaReceiver<String, String>(ConsumerFactory.INSTANCE, receiverOptions);
    }
